...
public class FTPClient {
    private static final String DEFAULT_DOWNLOAD_DIRECTORY = "C:\\Users\\lucas\\Documents\\Sistemais Operacionais\\FTPApplication\\"; // Defina o diretório padrão para salvar os arquivos recebidos

    public static void main(String[] args) throws UnknownHostException, IOException {
        String serverAddress = "26.132.1.15";
